...
//               // Retrieve attendance data directly as Map<DateTime, bool>
//               Map<DateTime, bool> attendanceData = userController.attendanceData.value ?? {};

//               return AttandanceCalendar(
//                 datesToShow: _getDatesToShow(_selectedLabel, _selectedDate),
...
//   Map<DateTime, bool> _convertAttendanceData(List<Map<String, dynamic>> attendanceData) {
//     Map<DateTime, bool> attendanceMap = {};

//     for (var data in attendanceData) {
//       DateTime date = (data['date'] as Timestamp).toDate();
//       attendanceMap[DateTime(date.year, date.month, date.day)] = true; // Assuming presence
//     }
